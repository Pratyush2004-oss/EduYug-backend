...
7.  **Flashcards:** Generate **exactly 12 flashcard objects**. The \`"front"\` should be a key term or concept, and the \`"back"\` should be a clear, concise definition or explanation.
